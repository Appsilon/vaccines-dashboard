...
drawer_txt <- list(
  "MCV1" = tagList(
    H4("Measles vaccine"),
    Text(
      "Measles is a highly contagious virus-caused disease that, despite a safe and effective
  ...
  "BCG" = tagList(
    ...
    Text(
      "Developed more than a century ago, bacille Calmette–Guérin vaccine (BCG) is currently
    ...
    Text(
      "Determining which are the most deadly VPDs requires acknowledging that some vaccinations
    ...
    br(),
    Text(
      "The vaccine for TB – Bacillus Calmette–Guérin (BCG) – has been in use for nearly 100 years.
      It protects against severe forms of TB
      but is not effective against pulmonary TB (in the lungs)
    ...
    Text(
      "Furthermore, resistance of antibiotics used to treat TB is increasing, meaning some people
      can no longer be cured by drugs.
      The estimated number of people in 2016 with multi-drug resistant TB was 490,000.
      (see: 'https://www.who.int/news-room/questions-and-answers/item/tuberculosis-multidrug-resistant-tuberculosis-(mdr-tb)')" # nolint: line_length_linter
    ),
    Text(
      "The fact that there is not a fully effective vaccine and that antibiotic treatment
  ...
  "Pol3" = tagList(
    H4("Polio vaccine"),
    Text(
      "Poliomyelitis (OPV, IPV) is a highly infectious viral disease. Once the poliovirus invades
  ...
  "HepB3" = tagList(
    ...
    Text(
      "Hepatitis B (HepB) is a highly contagious viral infection that attacks the liver and
      is transmitted through contact with the blood or other body fluids of an infected person.
      It is estimated that about 100,000 people die each year
      of chronic liver disease due to hepatitis B.
    ...
    H4("The most deadly VPDs (The vaccine-preventable diseases)"),
    Text(
      "Determining which are the most deadly VPDs requires acknowledging
      that some vaccinations are more effective than others.
  ...
  "DTP3" = tagList(
    ...
    Text(
      "Diphtheria, tetanus, and pertussis are all bacterial diseases and a combination
    ...
    UL(tags$li(
      "Tetanus is not passed person-to-person but through spores of a bacteria living
    ...
    Callout(
      ...
      hr(),
      "More: 'https://www.who.int/news/item/15-07-2022-covid-19-pandemic-fuels-largest-continued-backslide-in-vaccinations-in-three-decades'" # nolint: line_length_linter
    )
  ),
  "RotaC" = tagList(
    H4("Rotavirus vaccines"),
    Text(
      "The first widely-used rotavirus vaccine was approved in the United States in 2006.
    ...
    br(),
    Text(
      "Since the use of rotavirus vaccines have been approved, they have had
      a notable impact on the reduction of rotavirus-related deaths.
      According to a study published in 2018,
      the use of rotavirus vaccines prevented approximately 28,900 child deaths globally in 2016."
    )
  ),
  "PCV3" = tagList(
    H4("Pneumococcal vaccines"),
    Text(
      "There are a number of ways we could reduce the number of children dying from pneumonia,
    ...
    Text(
      "But we have another highly effective intervention: a vaccine against the major
      pathogen responsible for pneumonia in children."
    ),
    br(),
    Text(
      "Streptococcus pneumoniae is the leading cause of pneumonia in children under 5 —
...
drawer_questions <- list(
  ...
  Text(
    "Family/friends | Religious leader | Doctor/nurse |
    Famous person | Traditional healer | Don't know/refused | N/A"
  ),
  br(),
  H6(
    "Q21 In general, how much do you trust medical and health advice
    from the government of this country?"
  ),
  Text("A lot | Some | Not much | Not at all | Don't know | Refused"),
  br(),
  H6(
    "Q22 In general, how much do you trust medical and health advice from medical workers,
    such as doctors and nurses, in this country?"
  ),
  Text("A lot | Some | Not much | Not at all | Don't know | Refused"),
  br(),
  H6(
    "Q23 A vaccine is given to people to strengthen their body's ability to fight certain diseases.
  ...
  br(),
  H6(
    "Q24 Do you strongly or somewhat agree, strongly or somewhat disagree or neither
    agree nor disagree with the following statements?
    'Vaccines are important for children to have'."
  ),
  Text(
    "Strongly agree | Somewhat agree | Neither agree nor disagree |
    Somewhat disagree | Strongly disagree | Don't know/refuse | squere"
  ),
  br(),
  H6(
  ...
  br(),
  H6(
    "Q26 Do you strongly or somewhat agree, strongly or somewhat disagree or
